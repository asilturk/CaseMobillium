...
class SimiliarMoviesView: UIView {
...
extension SimiliarMoviesView: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return viewModel.dummySimilarMovieArray.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let model = viewModel.dummySimilarMovieArray[indexPath.row]
